            ...
            <div>
                <div className="row">
                    <div className="col-md-10">
                        ...
                        {this.state.isLoaded ? <TicketTable tickets={this.state.filteredTickets} handleStatusChange={this.handleStatusChange}/> : <LoadImg/>}
...
function LoadImg () {
    return <img style={{alignContent:"center"}}src={require ('../images/loader.gif')} alt="loader"/>
}
